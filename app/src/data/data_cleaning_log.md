...
To guarantee a fair procedure for sonic feature extraction throughout all songs, only official song releases from standard recording LPs, standard recording EPs, and singles are obtained. Standard recording LPs, standard recording EPs, and singles represent the primary commercial initiatives where song writing and arrangement is purposeful and originally produced for a holistic listening experience.Official song releases from deluxe, remastered, remixed, acoustic, unplugged, live, and cover editions represent the secondary commercial initiatives where song writing and arrangement is purposeful and originally produced for a holistic listening experience. Restricting the pipeline to consume song releases from standard recording LPs, standard recording EPs, and singles establishes a sonic control variable. The restriction enables the PCA Plot clustering to reflect differences in song structure and musical qualities with a greater level of accuracy rather than a multitude of differences in varying recording environments and commercial engineering outputs. The PCA Plot presents unique sonic representations of each selected song.
